...
def download_all_logbooks():
    logger.info("Downloading all logbooks")
...
# Paste this url in Edge browser , It will show the logbook

# url = f"https://f28ecentre01.intel.com/ecweb/echttpproxy/ASML.TWINSCAN.M$Mn.HTTP/AIDwebdav/root/service_data/Passdown/action_old.txt"
# url = f"https://f28ecentre01.intel.com/ecweb/echttpproxy/ASML.TWINSCAN.MJE30.HTTP/AIDwebdav/root/service_data/Passdown/action_old.txt"
# url = f"https://f28ecentre01.intel.com/ecweb/echttpproxy/ASML.TWINSCAN.M$Mn.HTTP/AIDwebdav/root/service_data/Passdown/action.txt"
...
def download_file(url, save_path, username=None, password=None):
    try:
        ...
        logger.info(f"Logbook downloaded successfully and saved to: {save_path}")
    except requests.exceptions.SSLError as ssl_err:
        logger.error(f"SSL certificate verification failed: {ssl_err}")
    except requests.exceptions.RequestException as e:
        logger.error(f"Error downloading logbook file : {e}")
