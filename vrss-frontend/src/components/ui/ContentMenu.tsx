      ...
      {enabaleContentMenu && (
        <div>
          ...
          <div className="mb-0 w-[100%] bg-gray-800 px-2 py-1 text-center capitalize">
            <span className="ml-2 text-sm font-semibold tracking-wider text-white">
              contents{" "}
            </span>
            <span
              className={`${showContent ? `text-red-400` : `text-teal-400`} cursor-pointer text-xs`}
          ...
          <ul
            ref={ulRef}
            style={
              showContent ? { height: `${contentHeight}px` } : { height: "0px" }
            }
